                                        ...
                                        <tbody>
                                            ...
                                            <tr>                                                    
                                                ...
                                                <td class="d-flex justify-content-center text-center gap-2"> 
                                                    <div>
                                                        <a href="Clientes?accion=editar&idCliente=<%= cli.getIdClienteProveedor()%>" class="btn btn-primary">
                                                            Actualizar
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <a href="Clientes?accion=eliminar&idCliente=<%= cli.getIdClienteProveedor()%>" class="btn btn-danger">
                                                            Eliminar
                                                        </a>
                                                    </div>
                                                </td>
