                            ...
                            <div class="card-body">
                                <form method="post" action="Clientes">
                                    <%
                                        ...
                                        ClienteProveedor cli = (ClienteProveedor)dao.getById(id);
                                    %>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-6 mb-3">
                                                <div class="example">
                                                    ...
                                                    <input class="form-control" type="hidden" required="true" name="idCliente" value="<%= cli.getIdClienteProveedor()%>">
                                                    <input class="form-control" type="text" required="true" name="cliNombre" value="<%= cli.getCliProNombre()%>">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 mb-3">
                                                <div class="example">
                                                    <p class="mb-1 text-primary">Apellidos:</p>
                                                    <input type="text" class="form-control" required="true" name="cliApellido" value="<%= cli.getCliProApellido()%>">
                                                </div>
                                            </div>                                            
                                        </div>                                                                     
                                        <div class="row">                            
                                            <div class="col-xl-6 mb-3">
                                                <div class="example">
                                                    ...
                                                    <input type="number"  class="form-control" maxlength="10"  required="true" name="cliCedula" value="<%= cli.getCliProCedula()%>">
                                                </div>
                                            </div>      
                                            <div class="col-xl-6 mb-3">
                                                <div class="example">
                                                    <p class="mb-1 text-primary">Email:</p>
                                                    <input class="form-control" type="email" required="true" name="cliEmail" value="<%= cli.getCliProEmail()%>">
                                                </div>
                                            </div>
                                        </div>                                                                     
                                        <div class="row">                            
                                            <div class="col-xl-6 mb-3">
                                                <div class="example">
                                                    ...
                                                    <input type="tel" maxlength="11" class="form-control" required="true" name="cliTelefono" value="<%= cli.getCliProTelefono()%>">
                                                </div>
                                            </div>                                            
                                        </div>                                                                                                                                                            
                                    </div>
